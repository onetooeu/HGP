...
export function mountHeader(cfg){
  ...
  if (!el) return;
  const links = [
    ["HGPeDU","https://hgpedu.eu/"],
    ["Portal Home","https://portal.onetoo.eu/"],
    ["Registry","https://portal.onetoo.eu/entities"],
    ["Search","https://portal.onetoo.eu/search"],
    ["Federation","https://portal.onetoo.eu/federation"],
    ["Audit","https://portal.onetoo.eu/audit"],
    ["Artifacts","https://portal.onetoo.eu/artifacts"],
    ["AMS ✨","/onetoo/ams.html"],
    ["Status","https://portal.onetoo.eu/status"],
    ["Docs","https://portal.onetoo.eu/docs"],
  ];
